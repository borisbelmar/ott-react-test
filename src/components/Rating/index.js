...
function Rating(props) {
    ...
    for (let i = 1; i <= 5; i++) {
        if(i <= props.rating) {
            ratingArray.push(
                <svg xmlns="http://www.w3.org/2000/svg" key={i} viewBox="0 0 15 15" className="star"><polygon  points="7.5 11.7 12 14.5 10.8 9.3 14.9 5.8 9.6 5.4 7.5 0.5 5.4 5.4 0.2 5.8 4.2 9.3 3 14.5 7.5 11.7"/></svg>
            );
        } else {
            ratingArray.push(
